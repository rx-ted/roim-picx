...
<template>
  <div class="mx-auto max-w-7xl my-8 px-4 sm:px-6 relative min-h-[60vh]">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
      ...
      <div class="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
        ...
        <BaseButton type="indigo" @click="handleCreate" class="flex-shrink-0" :disabled="!isLoggedIn"
  ...
  <BaseDialog v-model="dialogVisible" :title="dialogMode === 'create' ? $t('album.create') : $t('album.edit')"
    ...
    <div class="space-y-4">
      <BaseInput v-model="currentAlbum.name" :label="$t('album.name')" :placeholder="$t('album.namePlaceholder')" />
